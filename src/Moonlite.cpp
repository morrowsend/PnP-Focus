  ...
  switch (currentAsciiCommand[0])
    {
     case '2':
      switch (currentAsciiCommand[1])
        {
          case 'C':
          currentCommand.commandID = ML_2C;
          break;
          case 'F':
          switch (currentAsciiCommand[2])
            {
              case 'G':
                currentCommand.commandID = ML_2FG;
                break;
              case 'Q':
                currentCommand.commandID = ML_2FQ;
                break;
              default:
                currentCommand.commandID = ML_2UNKNOWN_COMMAND;
                break;
            }
            break;
          case 'G':
            ...
            {
              case 'B':
                currentCommand.commandID = ML_2GB;
                break;
              case 'C':
                currentCommand.commandID = ML_2GC;
                break;
              case 'D':
                currentCommand.commandID = ML_2GD;
                break;
              case 'H':
                currentCommand.commandID = ML_2GH;
                break;
              case 'I':
                currentCommand.commandID = ML_2GI;
                break;
              case 'N':
                currentCommand.commandID = ML_2GN;
                break;
              case 'P':
                currentCommand.commandID = ML_2GP;
                break;
              case 'T':
                currentCommand.commandID = ML_2GT;
                break;
              case 'V':
                currentCommand.commandID = ML_2GV;
                break;
              default:
                currentCommand.commandID = ML_2UNKNOWN_COMMAND;
                break;
        ...
        case 'S':
          switch (currentAsciiCommand[2])
              ...
              case 'N':
                ...
                break;
              case 'P':
                currentCommand.commandID = ML_2SP;
                currentCommand.parameter = convert4CharToLong(currentAsciiCommand[2], currentAsciiCommand[3], currentAsciiCommand[4], currentAsciiCommand[5]);
                break;
              default:
                currentCommand.commandID = ML_2UNKNOWN_COMMAND;
          ...
          break;
        case '+':
          currentCommand.commandID = ML_2PLUS;
          break;
        case '-':
          currentCommand.commandID = ML_2MINUS;
          break;
        case 'P':
          currentCommand.commandID = ML_2PO;
          currentCommand.parameter = convert2CharToSignedLong(currentAsciiCommand[2], currentAsciiCommand[3]);
          break;
